 ...
 *
 * @param {Object} `options` Options to configure the modifier.
 * @param {String} `options.name` Required name of the modifier
 * @param {String|Type} `options.type` Type of modifier to create. Defaults to `modifier`. Values may be `['modifier', 'logger']`.
 * @api public
 */
...
/**
 * Custom inspect method for displaying the modifier on the console.
 *
